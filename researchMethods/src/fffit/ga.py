...
A Genetic algorithm it's a search technique used in computer science
to find approximate solutions to optimization and search problems.

the algorithm has the following steps:
    1 - Creates a random initial population.
    2 - Calculates fitness from this random population.
    3 - from the initial population is generated deversification with cross
    between parents of the initial population,
    thus generating a new population of more relevant parents and children from the crossing.
    4 - mutates the population but with lower frequency, thus generating more diversification among the population.
"""
